...
-- 正在导出表  db_webapp.tb_student 的数据：~8 rows (大约)
/*!40000 ALTER TABLE `tb_student` DISABLE KEYS */;
INSERT INTO `tb_student` (`id`, `user_no`, `user_name`, `user_pwd`, `user_sex`, `user_birth`, `user_class`, `createtime`, `updatetime`) VALUES
